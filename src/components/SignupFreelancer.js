...
import Image from "../assets/signup-freelancer.svg";
...
function SignupFreelancer() {
    ...
    return (
        ...
        <FormHeader inner >
            <Link to="/" css={Links}>
                <div css={css`display:flex;align-items:center;flex-direction: row;gap: 6px;cursor: pointer`}>
                    <i class="fa-solid fa-arrow-left-long"></i>
                    Back
                </div>
            </Link>
        ...
        <FormSection>
            ...
            <ImagePreviewSection>
                <Description inner css={gradientText}>Your production needs a better story!</Description>
